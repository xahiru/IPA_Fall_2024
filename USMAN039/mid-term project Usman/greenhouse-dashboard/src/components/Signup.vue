    ...
    <div id="bdy">
        <div class="login-page">
            ...
            <form class="login-form" @submit.prevent="signup_page">
                ...
                <input type="text" id="name" class="input-field" v-model="username" placeholder="Enter your full name" required>
...
body {
    ...
    background: linear-gradient(135deg, #f93131, #af5800);
    display: flex;
    align-items: center;
...
.button {
    ...
    font-weight: 600;
    color: white;
    background: linear-gradient(90deg, #e45700, #daab02);
    border: none;
    cursor: pointer;
    border-radius: 8px;
    transition: all 0.3s ease;
...
.button:hover {
    ...
    background: linear-gradient(90deg, #c90000, #ff5b5b);
}
