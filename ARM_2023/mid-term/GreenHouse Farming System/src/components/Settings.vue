    ...
    <main>
      ...
      <form @submit.prevent="saveSettings" class="settings-form">
        <div class="form-group">
          ...
          <input id="temperature" type="number" v-model="settings.temperatureThreshold" />
        </div>

        <div class="form-group">
          <label for="humidity">Humidity Threshold (%)</label>
          <input id="humidity" type="number" v-model="settings.humidityThreshold" />
        </div>

        <div class="form-group">
          <label for="moisture">Moisture Threshold (%)</label>
          <input id="moisture" type="number" v-model="settings.moistureThreshold" />
        </div>

        <div class="form-group">
          <label for="light">Light Threshold (lx)</label>
          <input id="light" type="number" v-model="settings.lightThreshold" />
        </div>
