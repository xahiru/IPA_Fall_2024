...
#bdy {
  ...
  background: linear-gradient(135deg, #f0c27b, #9a61c9);
...
.login-page {
  ...
  width: 100%;
  text-align: center;
  background: rgba(233, 99, 204, 0.952);
  padding: 30px;
  border-radius: 15px;
  box-shadow: 0 10px 30px rgba(231, 84, 199, 0.555);
}
...
.input-field {
  padding: 12px 15px;
  font-size: 1rem;
  border: 1px solid #6057b3;
  border-radius: 8px;
  outline: none;
  background: rgba(164, 77, 167, 0.9);
...
.button {
  ...
  font-weight: 600;
  color: white;
  background: linear-gradient(90deg, #9492c0, #391685);
  border: none;
  cursor: pointer;
  border-radius: 8px;
...
.button:hover {
  ...
  background: linear-gradient(90deg, #db62d5, #c53aa7);
}
